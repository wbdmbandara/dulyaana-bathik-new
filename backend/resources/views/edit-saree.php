                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                ...
                                <?php if(!empty($additional_images) && is_array($additional_images)): ?>
                                    <?php $additionalImages = $additional_images; ?>
                                    <div class="mb-2" id="existingAdditionalImagesContainer">
                                        <p class="text-muted small">Current additional images:</p>
                                        <div class="d-flex flex-wrap gap-2">
                                            <?php foreach($additionalImages as $index => $image_path): ?>
                                                <?php if(file_exists(public_path($image_path))): ?>
                                                    <div class="position-relative">
                                                        <img src="/<?= $image_path ?>" alt="Additional Image" class="img-thumbnail" style="max-height: 150px; max-width: 150px;">
                                        ...
                                        <input type="hidden" name="existing_additional_images" value="<?= htmlspecialchars(json_encode($additional_images)) ?>">
                                    </div>
                                <?php elseif(session()->has('temp_additional_images') && !empty(session('temp_additional_images'))): ?>
                                    <div class="mb-2" id="existingAdditionalImagesContainer">
                                        <p class="text-muted small">Current additional images:</p>
                                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <div class="mb-2">
                                ...
                                <?php if(!empty($videos) && is_array($videos)): ?>
                                    <div class="mb-2" id="existingVideosContainer">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <?php foreach($videos as $index => $videoPath): ?>
                                        ...
                                        <input type="hidden" name="existing_videos" value="<?= htmlspecialchars(json_encode($videos)) ?>">
                                    </div>
                                <?php elseif(session()->has('temp_videos') && !empty(session('temp_videos'))): ?>
                                    <div class="mb-2" id="existingVideosContainer">
                                        <p class="text-muted small">Current videos:</p>
                                        <div class="d-flex flex-wrap gap-2">
