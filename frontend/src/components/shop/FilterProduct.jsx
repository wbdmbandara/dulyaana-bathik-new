      ...
      <div className="product-categories-widget widget-item">
        ...
        <ul className="category-tree list-unstyled mb-0">
          ...
          <li className="category-item">
            <div className="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-1-clothing-subcategories" aria-expanded="false" aria-controls="categories-1-clothing-subcategories">
              <a href="javascript:void(0)" className="category-link">Clothing</a>
              <span className="category-toggle">
                <i className="bi bi-chevron-down"></i>
                <i className="bi bi-chevron-up"></i>
              </span>
            </div>
            <ul id="categories-1-clothing-subcategories" className="subcategory-list list-unstyled collapse ps-3 mt-2">
              <li><a href="#" className="subcategory-link">Men's Wear</a></li>
              <li><a href="#" className="subcategory-link">Women's Wear</a></li>
              <li><a href="#" className="subcategory-link">Kids' Clothing</a></li>
              <li><a href="#" className="subcategory-link">Accessories</a></li>
            </ul>
          </li>
          ...
          <li className="category-item">
            ...
            <ul id="categories-1-electronics-subcategories" className="subcategory-list list-unstyled collapse ps-3 mt-2">
              <li><a href="#" className="subcategory-link">Smartphones</a></li>
              <li><a href="#" className="subcategory-link">Laptops</a></li>
              <li><a href="#" className="subcategory-link">Tablets</a></li>
              <li><a href="#" className="subcategory-link">Accessories</a></li>
            </ul>
          </li>
          ...
          <li className="category-item">
            <div className="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-1-home-subcategories" aria-expanded="false" aria-controls="categories-1-home-subcategories">
              <a href="javascript:void(0)" className="category-link">Home &amp; Kitchen</a>
              <span className="category-toggle">
                <i className="bi bi-chevron-down"></i>
                <i className="bi bi-chevron-up"></i>
              </span>
            </div>
            <ul id="categories-1-home-subcategories" className="subcategory-list list-unstyled collapse ps-3 mt-2">
              <li><a href="#" className="subcategory-link">Furniture</a></li>
              <li><a href="#" className="subcategory-link">Kitchen Appliances</a></li>
              <li><a href="#" className="subcategory-link">Home Decor</a></li>
              <li><a href="#" className="subcategory-link">Bedding</a></li>
            </ul>
          </li>
          ...
          <li className="category-item">
            ...
            <ul id="categories-1-beauty-subcategories" className="subcategory-list list-unstyled collapse ps-3 mt-2">
              <li><a href="#" className="subcategory-link">Skincare</a></li>
              <li><a href="#" className="subcategory-link">Makeup</a></li>
              <li><a href="#" className="subcategory-link">Hair Care</a></li>
              <li><a href="#" className="subcategory-link">Fragrances</a></li>
            </ul>
          </li>
          ...
          <li className="category-item">
            ...
            <ul id="categories-1-sports-subcategories" className="subcategory-list list-unstyled collapse ps-3 mt-2">
              <li><a href="#" className="subcategory-link">Fitness Equipment</a></li>
              <li><a href="#" className="subcategory-link">Outdoor Gear</a></li>
              <li><a href="#" className="subcategory-link">Sports Apparel</a></li>
              <li><a href="#" className="subcategory-link">Team Sports</a></li>
            </ul>
          </li>
          ...
          <li className="category-item">
            <div className="d-flex justify-content-between align-items-center category-header">
              <a href="#" className="category-link">Books</a>
            </div>
          </li>

          {/* Toys & Games Category */}
          <li className="category-item">
            <div className="d-flex justify-content-between align-items-center category-header collapsed" data-bs-toggle="collapse" data-bs-target="#categories-1-toys-subcategories" aria-expanded="false" aria-controls="categories-1-toys-subcategories">
              <a href="javascript:void(0)" className="category-link">Toys &amp; Games</a>
              <span className="category-toggle">
                <i className="bi bi-chevron-down"></i>
                <i className="bi bi-chevron-up"></i>
              </span>
            </div>
            <ul id="categories-1-toys-subcategories" className="subcategory-list list-unstyled collapse ps-3 mt-2">
              <li><a href="#" className="subcategory-link">Board Games</a></li>
              <li><a href="#" className="subcategory-link">Puzzles</a></li>
              <li><a href="#" className="subcategory-link">Action Figures</a></li>
              <li><a href="#" className="subcategory-link">Educational Toys</a></li>
            </ul>
          </li>
        </ul>
      ...
      <div className="pricing-range-widget widget-item">
        ...
        <div className="price-range-container">
          ...
          <div className="range-slider d-none">
            ...
            <div className="slider-progress" style={{ left: '0%', width: '50%' }}></div>
          ...
          <div className="color-options">
            ...
            <div className="form-check color-option">
              ...
              <label className="form-check-label" htmlFor="color-orange">
                <span className="color-swatch" style={{ backgroundColor: '#FFA500' }} title="Orange"></span>
              </label>
            </div>
      ...
      <div className="brand-filter-widget widget-item">
        ...
        <div className="brand-filter-content">
          <div className="brand-search">
            <input type="text" className="form-control" placeholder="Search brands..." spellCheck="false" data-ms-editor="true" />
